...
const App: () => Node = () => {
  ...
  //useStates from all labels inputtext
  const [textName1, onChangetextName1] = React.useState(
    'Ingresa el Nombre del Competidor 1',
  );

  const [textName2, onChangetextName2] = React.useState(
